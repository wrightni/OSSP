 ...
 */
          ...
          __pyx_t_20 = -1;
          if (__pyx_t_27 < 0) {
            __pyx_t_27 += __pyx_v_clsf_block_view.shape[0];
            if (unlikely(__pyx_t_27 < 0)) __pyx_t_20 = 0;
          } else if (unlikely(__pyx_t_27 >= __pyx_v_clsf_block_view.shape[0])) __pyx_t_20 = 0;
          if (__pyx_t_28 < 0) {
            __pyx_t_28 += __pyx_v_clsf_block_view.shape[1];
            if (unlikely(__pyx_t_28 < 0)) __pyx_t_20 = 1;
          } else if (unlikely(__pyx_t_28 >= __pyx_v_clsf_block_view.shape[1])) __pyx_t_20 = 1;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
            __PYX_ERR(0, 40, __pyx_L1_error)
          }
          *((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_clsf_block_view.data + __pyx_t_27 * __pyx_v_clsf_block_view.strides[0]) ) + __pyx_t_28 * __pyx_v_clsf_block_view.strides[1]) )) = 0;
 ...
 */
        /*else*/ {
          ...
          } else if (unlikely(__pyx_t_29 >= __pyx_v_label_image_view.shape[0])) __pyx_t_20 = 0;
          if (__pyx_t_30 < 0) {
            __pyx_t_30 += __pyx_v_label_image_view.shape[1];
            if (unlikely(__pyx_t_30 < 0)) __pyx_t_20 = 1;
          } else if (unlikely(__pyx_t_30 >= __pyx_v_label_image_view.shape[1])) __pyx_t_20 = 1;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
            __PYX_ERR(0, 42, __pyx_L1_error)
          }
          __pyx_t_31 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_label_image_view.data + __pyx_t_29 * __pyx_v_label_image_view.strides[0]) ) + __pyx_t_30 * __pyx_v_label_image_view.strides[1]) )));
          __pyx_t_20 = -1;
          if (unlikely(__pyx_t_31 >= (size_t)__pyx_v_prediction.shape[0])) __pyx_t_20 = 0;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
            __PYX_ERR(0, 42, __pyx_L1_error)
          }
          ...
          __pyx_t_20 = -1;
          if (__pyx_t_32 < 0) {
            __pyx_t_32 += __pyx_v_clsf_block_view.shape[0];
            if (unlikely(__pyx_t_32 < 0)) __pyx_t_20 = 0;
          } else if (unlikely(__pyx_t_32 >= __pyx_v_clsf_block_view.shape[0])) __pyx_t_20 = 0;
          if (__pyx_t_33 < 0) {
            __pyx_t_33 += __pyx_v_clsf_block_view.shape[1];
            if (unlikely(__pyx_t_33 < 0)) __pyx_t_20 = 1;
          } else if (unlikely(__pyx_t_33 >= __pyx_v_clsf_block_view.shape[1])) __pyx_t_20 = 1;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
            __PYX_ERR(0, 42, __pyx_L1_error)
          }
          *((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_clsf_block_view.data + __pyx_t_32 * __pyx_v_clsf_block_view.strides[0]) ) + __pyx_t_33 * __pyx_v_clsf_block_view.strides[1]) )) = (*((int *) ( /* dim=0 */ (__pyx_v_prediction.data + __pyx_t_31 * __pyx_v_prediction.strides[0]) )));
        }
        __pyx_L11:;
      }
    }
 ...
 */
        ...
        } else if (unlikely(__pyx_t_34 >= __pyx_v_intensity_image_view.shape[0])) __pyx_t_20 = 0;
        if (__pyx_t_35 < 0) {
          __pyx_t_35 += __pyx_v_intensity_image_view.shape[1];
          if (unlikely(__pyx_t_35 < 0)) __pyx_t_20 = 1;
        } else if (unlikely(__pyx_t_35 >= __pyx_v_intensity_image_view.shape[1])) __pyx_t_20 = 1;
        if (__pyx_t_36 < 0) {
          __pyx_t_36 += __pyx_v_intensity_image_view.shape[2];
          if (unlikely(__pyx_t_36 < 0)) __pyx_t_20 = 2;
        } else if (unlikely(__pyx_t_36 >= __pyx_v_intensity_image_view.shape[2])) __pyx_t_20 = 2;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
 ...
 */
        ...
        } else if (unlikely(__pyx_t_37 >= __pyx_v_intensity_image_view.shape[0])) __pyx_t_20 = 0;
        if (__pyx_t_38 < 0) {
          __pyx_t_38 += __pyx_v_intensity_image_view.shape[1];
          if (unlikely(__pyx_t_38 < 0)) __pyx_t_20 = 1;
        } else if (unlikely(__pyx_t_38 >= __pyx_v_intensity_image_view.shape[1])) __pyx_t_20 = 1;
        if (__pyx_t_39 < 0) {
          __pyx_t_39 += __pyx_v_intensity_image_view.shape[2];
          if (unlikely(__pyx_t_39 < 0)) __pyx_t_20 = 2;
        } else if (unlikely(__pyx_t_39 >= __pyx_v_intensity_image_view.shape[2])) __pyx_t_20 = 2;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
 ...
 */
        ...
        __pyx_t_20 = -1;
        if (__pyx_t_40 < 0) {
          __pyx_t_40 += __pyx_v_intensity_image_view.shape[0];
          if (unlikely(__pyx_t_40 < 0)) __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_40 >= __pyx_v_intensity_image_view.shape[0])) __pyx_t_20 = 0;
        if (__pyx_t_41 < 0) {
          __pyx_t_41 += __pyx_v_intensity_image_view.shape[1];
          if (unlikely(__pyx_t_41 < 0)) __pyx_t_20 = 1;
        } else if (unlikely(__pyx_t_41 >= __pyx_v_intensity_image_view.shape[1])) __pyx_t_20 = 1;
        if (__pyx_t_42 < 0) {
          __pyx_t_42 += __pyx_v_intensity_image_view.shape[2];
          if (unlikely(__pyx_t_42 < 0)) __pyx_t_20 = 2;
        } else if (unlikely(__pyx_t_42 >= __pyx_v_intensity_image_view.shape[2])) __pyx_t_20 = 2;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
          __PYX_ERR(0, 50, __pyx_L1_error)
        }
        __pyx_t_10 = (((((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intensity_image_view.data + __pyx_t_34 * __pyx_v_intensity_image_view.strides[0]) ) + __pyx_t_35 * __pyx_v_intensity_image_view.strides[1]) ) + __pyx_t_36 * __pyx_v_intensity_image_view.strides[2]) ))) == 0) & ((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intensity_image_view.data + __pyx_t_37 * __pyx_v_intensity_image_view.strides[0]) ) + __pyx_t_38 * __pyx_v_intensity_image_view.strides[1]) ) + __pyx_t_39 * __pyx_v_intensity_image_view.strides[2]) ))) == 0)) & ((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intensity_image_view.data + __pyx_t_40 * __pyx_v_intensity_image_view.strides[0]) ) + __pyx_t_41 * __pyx_v_intensity_image_view.strides[1]) ) + __pyx_t_42 * __pyx_v_intensity_image_view.strides[2]) ))) == 0)) != 0);
 ...
 */
          ...
          } else if (unlikely(__pyx_t_43 >= __pyx_v_clsf_block_view.shape[0])) __pyx_t_20 = 0;
          if (__pyx_t_44 < 0) {
            __pyx_t_44 += __pyx_v_clsf_block_view.shape[1];
            if (unlikely(__pyx_t_44 < 0)) __pyx_t_20 = 1;
          } else if (unlikely(__pyx_t_44 >= __pyx_v_clsf_block_view.shape[1])) __pyx_t_20 = 1;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
            __PYX_ERR(0, 51, __pyx_L1_error)
          }
          *((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_clsf_block_view.data + __pyx_t_43 * __pyx_v_clsf_block_view.strides[0]) ) + __pyx_t_44 * __pyx_v_clsf_block_view.strides[1]) )) = 0;
 ...
 */
        /*else*/ {
          ...
          __pyx_t_20 = -1;
          if (__pyx_t_45 < 0) {
            __pyx_t_45 += __pyx_v_prediction.shape[0];
            if (unlikely(__pyx_t_45 < 0)) __pyx_t_20 = 0;
          } else if (unlikely(__pyx_t_45 >= __pyx_v_prediction.shape[0])) __pyx_t_20 = 0;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
          ...
          __pyx_t_20 = -1;
          if (__pyx_t_46 < 0) {
            __pyx_t_46 += __pyx_v_clsf_block_view.shape[0];
            if (unlikely(__pyx_t_46 < 0)) __pyx_t_20 = 0;
          } else if (unlikely(__pyx_t_46 >= __pyx_v_clsf_block_view.shape[0])) __pyx_t_20 = 0;
          if (__pyx_t_47 < 0) {
            __pyx_t_47 += __pyx_v_clsf_block_view.shape[1];
            if (unlikely(__pyx_t_47 < 0)) __pyx_t_20 = 1;
          } else if (unlikely(__pyx_t_47 >= __pyx_v_clsf_block_view.shape[1])) __pyx_t_20 = 1;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
            __PYX_ERR(0, 53, __pyx_L1_error)
          }
          *((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_clsf_block_view.data + __pyx_t_46 * __pyx_v_clsf_block_view.strides[0]) ) + __pyx_t_47 * __pyx_v_clsf_block_view.strides[1]) )) = (*((int *) ( /* dim=0 */ (__pyx_v_prediction.data + __pyx_t_45 * __pyx_v_prediction.strides[0]) )));
        }
        __pyx_L16:;
      }
    }
